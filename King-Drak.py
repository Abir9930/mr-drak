#Coded By Zidan-ID\King Mr_Z17 & D3m0ni4k 
...
def main():
    ...
    os.system ('clear')
    print '[96m'
    os.system ('figlet abir ahmed')
    print'[92m================================='
    print'[97m Author  : [96mAbir '
    print'[97m WhatsApp     : [96m01309516756 '
    print'[97m Credits : [96mCoded By Abir Ahmed  '
    print'[92m================================='
    print'[92m++++++++++++ [97mTOOLS [92m++++++++++++'
    print'[92m[[97m1[92m] [97mKing Fb v1.7 '
    print'[92m[[97m2][92m [97mKing Fb v1.8 '
    print'[92m[[97m3[92m] [97mKing Fb Premium '
    print'[92m[[97m4[92m] [97mKing Fb New'
    print'[92m[[97m5[92m] [97mKing Fb Diamond '
    ...
    if gans in ['4']:
        ...
        print ('[97m$ lalu [93mpython2 darkfb.py')
        print ('[97m + Username [92mAbir')
        print ('[97m + Password [96mKing')
        exit()
    if gans in ['5']:
        time.sleep(1)
